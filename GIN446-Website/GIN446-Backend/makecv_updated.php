...
//to display CV
    ...
    while (isset($_POST["job{$expCount}title"])) {
        ...
        $formattedStart = date("F, Y", strtotime($edStart));
        $formattedEnd = $edEnd ? date("F, Y", strtotime($edEnd)) : "Present";
        $experienceHTML .= "<p>$company | $formattedStart - $formattedEnd</p>";
    ...
    while (isset($_POST["degree{$edCount}"])) {
        ...
        $formattedStart = date("F, Y", strtotime($edStart));
        $formattedEnd = $edEnd ? date("F, Y", strtotime($edEnd)) : "Present";
        $educationHTML .= "<p>Date: $formattedStart - $formattedEnd</p>";
        $educationHTML .= "</div>";
    ...
    while (isset($_POST["cert{$certCount}name"])) {
        ...
        $formattedDate = date("F, Y", strtotime($certDate));
        $certificationsHTML .= "<p>Date: $formattedDate</p>";
